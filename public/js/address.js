...
document.addEventListener("DOMContentLoaded", function () {
    getData('/api/address', provinsiList)
});

provinsi.onchange = function () {
    getData('/api/address/' + provinsi.value, kabupatenList)
}

kabupaten.onchange = function () {
    getData('/api/address/' + provinsi.value + '/' + kabupaten.value, kecamatanList)
}

kecamatan.onchange = function () {
    getData('/api/address/' + provinsi.value + '/' + kabupaten.value + '/' + kecamatan.value, kelurahanList)
}
...
kelurahan.onchange = function () {
    ...
    xhttp.open('GET', '/api/address/' + provinsi.value + '/' + kabupaten.value + '/' + kecamatan.value + '/' + kelurahan.value, true)
    xhttp.send()
}