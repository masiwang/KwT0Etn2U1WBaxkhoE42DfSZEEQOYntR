    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-12 col-lg-10 col-xl-8">
                <form class="mb-4" action="{{ url('/basecamp/market/product/new') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <label>Satuan</label>
                            <input type="text" class="form-control" name="size" placeholder="kg">
                        </div>
                    </div>
                    <div class="form-group mb-4">
